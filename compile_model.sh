...
(source ../../env; make NETCDF=3 REPRO=1 libfms.a)
...
(cd ../MOM6-examples/build/intel/ocean_only/repro/; rm -f path_names; \
 ...
 ../../../../src/mkmf/bin/mkmf -t ../../../../src/mkmf/templates/sam-linux-gnu.mk -o '-I../../shared/repro' -p MOM6 -l '-L../../shared/repro -lfms' -c '-Duse_netCDF -DSPMD' path_names)

(cd ../MOM6-examples/build/intel/ocean_only/repro/; source ../../env; make NETCDF=3 REPRO=1 MOM6)
